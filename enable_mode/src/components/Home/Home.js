...
function Home() {
  ...
  <div className="flex items-center flex-wrap mb-20">
    ...
    <div className="w-full md:w-1/2">
      <img  src="https://letsenhance.io/static/8f5e523ee6b2479e26ecc91b9c25261e/1015f/MainAfter.jpg" alt="Monitoring" />
    </div>
  </div>
  <div className="flex items-center flex-wrap mb-20">
    <div className="w-full md:w-1/2">
      <img className='rounded-lg' src="https://img.freepik.com/free-photo/bright-neon-colors-shining-wild-chameleon_23-2151682815.jpg" alt="" />
    </div>
  ...
  <div className="flex items-center flex-wrap mb-20">
    ...
    <div className="w-full md:w-1/2 rounded-lg">
      <img className='rounded-lg' src="https://media.gettyimages.com/id/1052202540/photo/colorful-panther-chameleon.jpg?b=1&s=612x612&w=0&k=20&c=f4P3J7RdnSTld9eKMksbSgdnXp7gUhrbU3PfXyWKgkM=" alt="" />
    </div>
  </div>
</div>
